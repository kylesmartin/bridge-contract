...
interface IRoninBridgeManager is VoteStatusConsumer, SignatureConsumer {
  ...
  function castProposalBySignatures(Proposal.ProposalDetail memory proposal, Ballot.VoteType[] memory supports_, Signature[] memory signatures) external;
  function castProposalVoteForCurrentNetwork(Proposal.ProposalDetail memory proposal, Ballot.VoteType support) external;
  ...
  function execute(Proposal.ProposalDetail memory proposal) external;
  function executeGlobal(GlobalProposal.GlobalProposalDetail memory globalProposal) external;
